...
class TestPlayerGame(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.player_df = self.spark.createDataFrame(player_data, ["playerID", "country", "BirthDate", "gender", "playerState", "VIP", "KYC", "wantsNewsletter", "latestUpdate"])
    ...
    def test_transform_data(self):
        ...
        expected_df = self.spark.createDataFrame(expected_data, ["player_id", "gender", "country", "latestUpdate"])
